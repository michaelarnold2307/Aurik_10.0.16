"""§Bridge: Einheitliche CalibrationContext-Datenstruktur für Frontend↔Backend.
...
§BRIDGE-INVARIANTE: Kein Frontend-Modul importiert jemals backend.* direkt.
ALLE Daten fließen über dieses Dict. Der Bridge-Callback ist der EINZIGE Pfad.
"""
